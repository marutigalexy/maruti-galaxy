...
import { getEntryReport } from "@/services/reports/reports-service";
import type { ListedEntries } from "@/services/entries/entries-service";

type EntryReportPageProps = {
...
export default async function EntryReportPage({ searchParams }: EntryReportPageProps) {
  ...
  try {
    ...
    return (
      <ErrorState title="Unable to load entry report" description="Something went wrong. Try again." />
    );
  }
